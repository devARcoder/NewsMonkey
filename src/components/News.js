...
export class News extends Component {
  ...
  async componentDidMount(){
    let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=0a9584b34eab4cb3929218488e65af44&page=1&pageSize=3"
  ...
  handlePreClick = async() =>{
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=0a9584b34eab4cb3929218488e65af44&page=${this.state.page - 1}&pageSize=3`
    let data = await fetch(url);
    let parsedData = await data.json();
    console.log(parsedData)
    this.setState({
