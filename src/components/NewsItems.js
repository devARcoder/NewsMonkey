...
const NewsItems = (props) => {
  let { name, title, desc, imageUrl, newsUrl, published, author } = props;
  return (
    <div>
      <div className="w-full max-w-sm bg-white border-2 border-gray-500 rounded-lg shadow-sm my-1">
        <h1 className="mb-1 text-xl font-medium text-white dark:text-white text-center bg-gray-800 p-2">
          {name}
        </h1>
        <div className="flex flex-col items-center p-4">
          <img
            ...
            src={
              !imageUrl
                ? "https://ambcrypto.com/wp-content/uploads/2025/02/Samyukhtha-45-1000x600.webp"
                : imageUrl
            }
            alt="error"
          />
        ...
        <p className="text-sm font-medium text-black dark:text-white text-center bg-gray-100 p-2">
